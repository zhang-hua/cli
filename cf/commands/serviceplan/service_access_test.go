...
var _ = Describe("service-access command", func() {
	...
	Describe("when logged in", func() {
		BeforeEach(func() {
			...
			actor.GetBrokersWithVisibilityFromASingleOrgReturns([]models.ServiceBroker{serviceBroker1}, nil)
			...
			actor.FilterBrokers([]models.ServiceBroker{
				serviceBroker1,
				serviceBroker2,
			},
				nil,
		...
		It("prints all of the brokers", func() {
			...
			Expect(ui.Outputs).To(ContainSubstrings(
				...
				[]string{"my-service-1", "burp", "private"},
